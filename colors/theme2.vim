...
" General Colors
" #1B1C1F or #1d1e21
hi Normal       guifg=#e0dfe1   guibg=#1a1a1a  ctermfg=251    ctermbg=235       gui=none      cterm=none
hi Comment      guifg=#8a8a8a   guibg=NONE      ctermfg=245    ctermbg=NONE      gui=italic      cterm=none
hi Constant     guifg=#ffc788   guibg=NONE      ctermfg=187    ctermbg=NONE      gui=none      cterm=none
hi Statement    guifg=#99bed5   guibg=NONE      ctermfg=110    ctermbg=NONE      gui=none      cterm=none
hi Type         guifg=#6f7f8d   guibg=NONE      ctermfg=152    ctermbg=NONE      gui=none      cterm=none
...
hi htmlTag guifg=#fffbc0   gui=NONE
