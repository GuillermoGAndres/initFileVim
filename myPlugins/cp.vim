...
function! TermWrapper(command) abort
	...
	exec 'term ' . a:command
	exec 'startinsert'
    set nonumber " Para que no se vean los numeros en nuevo buffer
endfunction
...
"  Comentmaos resize porque en mi nvim se estira la status bar hacia arriba
"  desacomodando los elementos
